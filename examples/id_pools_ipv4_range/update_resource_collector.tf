...
# Collects list of allocated Id's from the resource.
resource "oneview_ipv4_range" "ipv4range" {
  collector_id_list = ["<id_address1>", "<id_address2>"]
...
# Retains existing Enclosure Group to collect allocated Id's from it.
