...
func resourceServerProfileAsync() *schema.Resource {
	return &schema.Resource{
		Create: resourceServerProfileCreateAsync,
		Read:   resourceServerProfileReadAsync,
		Update: resourceServerProfileUpdateAsync,
		Delete: resourceServerProfileDeleteAsync,
...
func resourceServerProfileCreateAsync(d *schema.ResourceData, meta interface{}) error {
	config := meta.(*Config)
	...
	return resourceServerProfileReadAsync(d, meta)
}

func resourceServerProfileReadAsync(d *schema.ResourceData, meta interface{}) error {
...
func resourceServerProfileUpdateAsync(d *schema.ResourceData, meta interface{}) error {
	config := meta.(*Config)
...
func resourceServerProfileDeleteAsync(d *schema.ResourceData, meta interface{}) error {
	config := meta.(*Config)
...
// getServerHardware function moved to resource_server_profile.go to avoid duplication
