...
2. If an example is not working, verify the HPE OneView REST API Documentation ([OneView 4.0](http://h17007.www1.hpe.com/docs/enterprise/servers/oneview4.0/cic-api/en/index.html), [OneView 4.1](http://h17007.www1.hpe.com/docs/enterprise/servers/oneview4.1/cic-api/en/index.html), [OneView 4.2](http://h17007.www1.hpe.com/docs/enterprise/servers/oneview4.2/cic-api/en/index.html)) for the respective API version being used, since the expected attributes for that resource might have changed.
